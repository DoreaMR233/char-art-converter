...
public interface CharArtService {
     ...
     * @return 字符画图片的字节数组
     */
    byte[] convertToCharArt(InputStream imageStream, String filename, String density, String colorMode, String progressId, boolean limitSize);
     ...
     * @throws Exception 当获取字符文本过程中发生错误时抛出
     */
    Map<String,Object> getCharText(String filename) throws Exception;
}