...
public interface ProgressService {
     ...
     */
    void updateProgress(String id, int percentage, String message);
     ...
     */
    void updateProgress(String id, int percentage, String message, String stage, int currentPixel, int totalPixels);
